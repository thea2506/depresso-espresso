            ...
            for node in nodes:
                ...
                for author in authors:
                    ...
                    if not Author.objects.filter(url=author.items.url).exists():
                        ...
                        new_author.host = author.items.host
                        new_author.displayName = author.items.displayName
                        new_author.url = author.items.url
                        new_author.username = author.items.username
