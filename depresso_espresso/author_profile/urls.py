...
urlpatterns = [
    ...
    path('authors/<str:authorid>/followers/',
         views.get_followers, name='get_followers'),
    ...
    path('authors/<str:authorid>/following/',
         views.get_followers, name='get_following'),
    ...
    path('espresso-api/authors/<str:authorid>/followers',
         views.get_followers, name='api_get_followers'),
    ...
    path('espresso-api/authors/<str:authorid>/followers/<str:foreignid>',
         views.handle_follow, name='api_handle_follow'),

    # 5 POST //service/authors/create_follow_request/to/<str:foreignid>
    path('espresso-api/create-follow-request/to/<str:foreignid>',
         views.create_follow_request, name='create_follow_request'),
