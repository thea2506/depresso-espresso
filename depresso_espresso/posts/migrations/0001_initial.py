# Generated by Django 5.0.2 on 2024-03-17 01:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Post',
            fields=[
                ('url', models.CharField(db_column='postID', max_length=200, unique=True)),
                ('id', models.UUIDField(db_column='postUUID', default=uuid.uuid4, primary_key=True, serialize=False)),
