    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[('text/markdown', 'text/markdown'), ('text/plain', 'text/plain'), ('application/base64', 'application/base64'), ('image/png;base64', 'image/png;base64'), ('image/jpeg;base64', 'image/jpeg;base64')], max_length=50)),
                ('content', models.TextField()),
                ('count', models.IntegerField(blank=True, db_column='commentCount', null=True)),
